...
namespace newsApi
{
  ...
  {
   public static List<NewsResult> GetNews(string searchWord)
   {
     ...
     byte[] searchResult = webClient.DownloadData(string.Format("https://api.cognitive.microsoft.com/bing/v5.0/news/search?q={0}",searchWord));
